		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 animate-box" align="center"
					...
					if (recentURI != null) {
					%>
					<form action="JoinService?from=<%=recentURI%>" method="post"
						name="JoinForm">
						<%
						} else {
						%>
							...
							<div class="row form-group">
								<div class="col-md-6">
									<input type="email" name="email" id="email"
										class="form-control" placeholder="아이디(이메일)"> <font
										id="checkEmail" size="2"></font>
								</div>
								<div class="col-md-6">
							...
							<div class="row form-group">
								<div class="col-md-6">
									<input type="text" name="nick" id="nick" class="form-control"
										placeholder="닉네임"> <font id="checkNick" size="2"></font>
								</div>
							</div>
							<div class="row form-group">
								<div class="col-md-6">
